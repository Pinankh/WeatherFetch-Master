...
-keepclassmembers class com.pinankh.domain.models.* {
    public <init>();
}
...
-keep class com.pinankh.weatherproject.domain.models.** { *; }

-keep class com.pinankh.weatherproject.domain.models.common.** { *; }
